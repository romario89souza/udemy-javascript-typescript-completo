# Seção 29: NextJS (um framework baseado em React) e Strapi para criar API REST rapidamente

## Projetos e exercícios com pasta própria

- [`strapi/`](./strapi/) — Backend: Strapi (CMS headless + API REST)
- [`blog/`](./blog/) — Frontend: Blog em NextJS consumindo a API do Strapi

## Aulas

- [ ] 427. Sobre o NextJS e o Strapi
- [ ] 428. Strapi + PostgreSQL + Docker
- [ ] 429. Cloudinary - Provedor de arquivos
- [ ] 430. Configurando o provedor de arquivos
- [ ] 431. Configurando as tabelas (Content-Types Builder)
- [ ] 432. Liberando permissões na API
- [ ] 433. Deploy do Strapi no Heroku com Git
